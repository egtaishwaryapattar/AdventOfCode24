...
def part2(num_rows, num_cols):
    ...
    for line in lines:
        ...
        for index in list:
            if line_number > 0 and line_number <= (num_rows - 2) and index > 0 and index <= (num_cols - 2):

                # check the north_east/south west direction
                if ((lines[line_number + 1][index - 1] == 'M' and lines[line_number - 1][index + 1] == 'S') 
                    or (lines[line_number + 1][index - 1] == 'S' and lines[line_number - 1][index + 1] == 'M')):
...
part1(num_rows, num_cols)
part2(num_rows, num_cols)